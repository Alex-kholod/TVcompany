...
class MatrixType(models.Model):
    type_name = models.CharField(max_length=50, verbose_name="Название типа матрицы")
...
class Matrix(models.Model):
    ...
    matrix_type = models.ForeignKey(MatrixType, on_delete=models.PROTECT)
...
class Specifications(models.Model):
    ...
    matrix = models.ForeignKey(Matrix, on_delete=models.PROTECT)
    powerboard = models.ForeignKey(Powerboard, on_delete=models.PROTECT)
    mainplata = models.ForeignKey(Mainplata, on_delete=models.PROTECT)
    loudspeakers = models.ForeignKey(Loudspeakers, on_delete=models.PROTECT)
    casebox = models.ForeignKey(CaseBox, on_delete=models.PROTECT)
...
class Build(models.Model):
    ...
    count = models.IntegerField(verbose_name="Количество")
    tv = models.ForeignKey(TV, on_delete=models.CASCADE)
    line = models.ForeignKey(BuildLine, on_delete=models.CASCADE)
    staff = models.ForeignKey(StaffConstructor, on_delete=models.CASCADE)
